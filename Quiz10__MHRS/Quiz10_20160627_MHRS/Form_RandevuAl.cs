...
namespace Quiz10_20160627_MHRS
{
    public partial class Form_RandevuAl : Form
    {
        ...
        private void Form_RandevuAl_Load(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter daBolum = new SqlDataAdapter("SELECT * FROM Bolum", con);
            DataTable dtBolum = new DataTable();
            daBolum.Fill(dtBolum);
            cmb_bolumRandevuAl.DataSource = dtBolum;
